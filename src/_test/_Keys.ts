...
TestsOf("Keyable: ", {
  'Object Field Sanity   ': 
    [ () => assertEquals( Object(Keyable).hasOwnProperty('Fencing'), true ), 'continue with sound mind.' ],
  'field:         fencing': 
  ...
  'field:      HelloWorld': 
    [ () => assertEquals( Object(Keyable).hasOwnProperty('HelloWorld'), true, true ), 'has no HelloWorld key.' ],
});
